...
- `platform.rs`: all Win32 process/window/credential/hotkey/keepalive/floating-window/tray operations.
- `floating.rs`: GPUI presentation/state for the independent floating-ball and MSTSC-list popup components; native HWND work stays in `platform.rs`.
